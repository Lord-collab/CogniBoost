...
/// <summary>
/// Главная страница приложения (вкладка «Главная»).
///
/// Содержит:
///   — приветствие с аватаром пользователя;
///   — ежедневное задание (если активно — иконка + бонус ×2);
///   — чипы категорий навыков (фильтр для списка игр ниже);
///   — каталог игр: карточки с иконкой, названием, прогрессом и ценой;
///   — кнопка перехода к магазину, если есть заблокированные игры.
///
/// При появлении страницы обновляются баллы, стрик, данные игр.
/// </summary>
